...
const meta: Meta<any> = {
  ...
  parameters: {
    // SCInlineDropdownList is an inline editing control — label-less by design.
    // In production it sits inside a table cell where surrounding context
    // provides the accessible label. Suppress the label rule for this story.
    a11y: {
      options: {
...
const STATUS_OPTIONS = ['Pending', 'Active', 'Complete', 'Cancelled'];
