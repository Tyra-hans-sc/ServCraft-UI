        ...
        <SCWidgetCard >
            <div className="summary-widget-container">
                ...
                <Title order={5} fw={'bolder'} mb={'var(--mantine-spacing-md)'}>
                    We&apos;ve updated your Jobs List on ServCraft!
                </Title>
                <Text size={'sm'}  mb={5}>What can you look forward to with these changes?</Text>
                <List size={'sm'}
                      mb={5}
                ...
                <Text size={'sm'} mb={'var(--mantine-spacing-sm)'}>If you have any questions or feedback, feel free to reach out!</Text>
            ...
            <div className={`button-container`}>
                {
                    ...
                    <Button text={whatsNew.button.text} extraClasses="margin-auto hollow w7" onClick={() => {
                        Helper.mixpanelTrack(whatsNew.button.mixpanel.event, whatsNew.button.mixpanel.parameters as any);
