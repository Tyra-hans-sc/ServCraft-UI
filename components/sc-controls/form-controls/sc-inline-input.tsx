...
function SCInlineInput({ name, value, hint, onChange, onKeyPress, tabIndex, autoFocus = false, required = false, readOnly = false, type = "text", error, extraClasses, onBlur, min, width, textAlign = "left", ariaLabel = undefined }) {
