...
function NewCustomerDetails({inputs, selectedLocationType, selectedCountry, contacts, locations, editFunc, deleteFunc}) {
    const anyContactInputs = (inputs.FirstName != '' || inputs.LastName != '' || inputs.EmailAddress != '' || inputs.MobileNumber != '' ? true : false);
