...
function ManageInvoiceItem({ isNew, tab, itemID, module, jobInventory, hasAssets, customerID, invoiceItem, saveInvoiceItem, saveInvoiceItems, integration, companyTaxPercentage, accessStatus, cypressInventorySelector, cypressQuantity }) {
    ...
    <div className="overlay" onClick={(e) => e.stopPropagation()}>
      <div className="modal-container">
            ...
            case tabInventory:
              return <div key={0}>
                <InventorySelector selectedInventory={selectedInventory} setSelectedInventory={setSelectedInventory} setInventoryChanged={setInventoryChanged}
                  accessStatus={accessStatus} error={inputErrors.Inventory} cypress={cypressInventorySelector} />
                      ...
                      <thead>
                        <tr>
                          <th className="header-item-select">
                            {products.length > 0 ?
                              <SCCheckbox extraClasses={"no-margin"} value={selectAllAssets} onChange={() => handleSelectAllAssets()}
        ...
        <div className="actions">
          <Button text="Cancel" extraClasses="hollow auto" onClick={() => saveInvoiceItem(null)} />
