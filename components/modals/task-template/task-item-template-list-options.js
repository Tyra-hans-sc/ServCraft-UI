...
const TaskItemTemplateListOptions = ({ dataOption, setDataOption, error, disabled }) => {
    ...
    return (<div className={`${error ? "error" : ""}`}>
        <table >
            <Reorder reorderId="task-item-template-list-options" onReorder={onReorder} lock='horizontal' component='tbody'
        ...
        {disabled ? "" :
            <div className="row">
                <Button text="Add Option" icon="plus-circle-blue" extraClasses="hollow" onClick={() => addOption()} />
            </div>
        }
...
export default TaskItemTemplateListOptions;