...
const QuoteItems: FC<{ quoteItems: any[], module?: number, itemId?: string , mobileView: boolean}> = (props) => {

  const [orderedData, setOrderedData] = useState(
      props.quoteItems.map((x, i) => (
  ...
  const [groupedData, setGroupedData] = useState(getGroupedItems(orderedData, sectionNameKey, sectionIdKey))
    ...
    return (<>
        ...
        <div className="card">
            <h2 className="item-heading">Quote Items</h2>
                                ...
                                (!x.isSection || !x.hideLineItems) && x.items.map((y, j) => (
                                    ...
                                    >
                                        ...
                                        <td className="body-item-qty number-column" style={{fontWeight: 'normal'}}>
                                            {y.QuoteItemType === Enums.QuoteItemType.Inventory ?
                                                <>{y.Quantity}</>
                                                :
                                                ''
                                            }
                                        ...
                                        <td className="body-item-amt number-column" style={{fontWeight: 'normal'}}>
                                            {y.QuoteItemType == Enums.QuoteItemType.Description ? y.LineTotalExclusive : Helper.getCurrencyValue(y.LineTotalExclusive)}
                                        </td>
                                    </tr>
                                )),
