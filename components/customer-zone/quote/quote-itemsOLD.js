...
function QuoteItems(props) {
  ...
  const [quoteItems, setQuoteItems] = useState(props.quoteItems);

  return (<>

    <div className="card">
      <div className="heading">Quote Items</div>
      <br />
      <div className="table-container">
        <table className="table">
          ...
          <tbody>
            {quoteItems.length > 0 ?
              quoteItems.sort((a, b) => a.LineNumber - b.LineNumber).map(function (item, index) {
                return (
                  <tr key={index}>
                    ...
                    <td className="body-item-price number-column">
                      {item.QuoteItemType == Enums.QuoteItemType.Inventory ?
                    ...
                    <td className="body-item-discount number-column">
                      {item.QuoteItemType == Enums.QuoteItemType.Inventory ?
