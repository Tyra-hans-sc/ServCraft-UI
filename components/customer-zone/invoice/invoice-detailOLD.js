...
function InvoiceDetail(props) {
    ...
    const exportDocument = (endPoint) => {
      DownloadService.downloadFile("GET", `/CustomerZone/${endPoint}`, null, true, false, props.tenantID, props.customerID);
    }

    const printOptions = [
      { text: 'Invoice', link: `GetInvoiceDocument?invoiceID=${invoice.ID}` }
    ];
    ...
    <div className="row">
        <div className="card">
            <div className="row line-height-2rem">
                ...
                <CellStatus value={invoice.InvoiceStatus} valueEnum="InvoiceStatus" />
                {showPrint ? <>
                    <ButtonDropdown
