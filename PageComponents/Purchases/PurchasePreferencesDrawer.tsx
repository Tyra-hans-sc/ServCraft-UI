...
const LS_COL_MAPPING_NAME = 'purchase-order-doc'
...
const PurchasePreferencesDrawer: FC<{
        open: boolean;
        onClose: () => void;
   ...
   useQuery(['authConfig', Enums.ConfigurationSection.PurchaseOrder], () => UserConfigService.getSettings(Enums.ConfigurationSection.PurchaseOrder, Enums.ConfigurationType.CRUD),
        {
    ...
    const authConfigMutation = useMutation(['purchaseOrderDocAutConfig'], UserConfigService.saveConfig)
    ...
    return <>
        ...
        >
            ...
            <Alert
                ...
                // title={`Quote Columns`}
            >
                Updates won&apos;t affect the Purchase Order PDF.
            </Alert>
        </Drawer>
    </>
}

export default PurchasePreferencesDrawer