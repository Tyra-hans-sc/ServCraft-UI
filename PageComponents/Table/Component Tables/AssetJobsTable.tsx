...
const JobsTable: FC<{productId: string, module: number, customerID: string}> = ({productId, module, customerID}) => {
    ...
    const jobTableProps = useMemo<ScTableProps>(() => (
        {
            ...
            tableDataEndpoint: '/Job/GetJobsForProduct',
            tableName: 'productJobs',
            tableNoun: 'Job',
            tableFilterMetaData: {
                options: [
                    {
    ...
    return (
        <>
            ...
            <ScTable
                ...
                onAction={onAction}
            >
                <Link href={`/job/create?module=${module}&moduleID=${productId}&customerID=${customerID}`} onClick={() => Helper.nextLinkClicked('/job/create')}>
