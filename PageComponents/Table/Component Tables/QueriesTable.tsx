    ...
    const queryTableProps = useMemo<ScTableProps>(() => (
        {
            ...
            columMappingOverrideValues: {
                ...
                CreatedBy: {
                    DisplayValueFunction: (item) => <Text size={'sm'} c={'gray.7'}>{item.CreatedBy.trim() === 'System' ? 'Web Form' : item.CreatedBy.trim() === 'WebHook' ? 'Inbound Email' : item.CreatedBy}</Text>
                },
                CustomTextField1: {
                ...
                Priority: {
                    ...
                    MetaData: JSON.stringify({
                        colourMappingValues: {
                            [Enums.QueryPriorityColor.Low]: Enums.QueryPriority.Low,
                            [Enums.QueryPriorityColor.Medium]: Enums.QueryPriority.Medium,
                            [Enums.QueryPriorityColor.High]: Enums.QueryPriority.High,
                        },
                        mappingValues: Enums.QueryPriority
                    })
                }
            },
    ...
    return (
        <>
            ...
            >
                ...
                <Link href={'/query/create'} onClick={() => Helper.nextLinkClicked('/query/create')}>
