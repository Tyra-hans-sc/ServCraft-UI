...
import {
    IconEdit,
    IconFilterOff,
    IconTableExport, IconTrash, IconTrashOff
} from "@tabler/icons";
...
const AssetsTable: FC<{itemId: string; customerId: string; module: number}> = (props) => {
    ...
    return (
        <>
            ...
            >
                ...
                <Link href={`/asset/create?module=${props.module}&moduleID=${props.itemId}&customerID=${props.customerId}`} onClick={() => Helper.nextLinkClicked('/asset/create')}>
